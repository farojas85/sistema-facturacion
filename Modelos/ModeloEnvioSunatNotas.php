...
class ModeloEnvioSunatNotas
{
    ...
    public static function mdlActualizarNotaCreditoBaja($idVenta, $datos)
    {
    ...
    public static function mdlActualizarBajaFactura($datos)
    {
        ...
        {
            $stmt = Conexion::conectar()->prepare("SELECT * FROM nota_credito WHERE id = :id ORDER BY id");
