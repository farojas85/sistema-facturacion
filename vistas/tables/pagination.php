...
class Paginacion
{
	...
	public function paginarGuiasTuristicos($reload, $page, $tpages, $adjacents)
	{
		$prevlabel = "&lsaquo;";
		$nextlabel = "&rsaquo;";
		$out = '<ul class="pagination ">';
		...
		if ($page == 1) {
			...
			$out .= "<li><span><a href='javascript:void(0);' onclick='loadGuiasTuristicos(1)'>$prevlabel</a></span></li>";
		} else {
			$out .= "<li><span><a href='javascript:void(0);' onclick='loadGuiasTuristicos(" . ($page - 1) . ")'>$prevlabel</a></span></li>";
		}

		// first label
		if ($page > ($adjacents + 1)) {
			$out .= "<li><a href='javascript:void(0);' onclick='loadGuiasTuristicos(1)'>1</a></li>";
		}
		// interval
		if ($page > ($adjacents + 2)) {
			$out .= "<li><a>...</a></li>";
		...
		for ($i = $pmin; $i <= $pmax; $i++) {
			if ($i == $page) {
				...
				$out .= "<li><a href='javascript:void(0);' onclick='loadGuiasTuristicos(1)'>$i</a></li>";
			} else {
				$out .= "<li><a href='javascript:void(0);' onclick='loadGuiasTuristicos(" . $i . ")'>$i</a></li>";
			}
		}
		...
		if ($page < ($tpages - $adjacents)) {
			$out .= "<li><a href='javascript:void(0);' onclick='loadGuiasTuristicos($tpages)'>$tpages</a></li>";
		}

		// next

		if ($page < $tpages) {
			$out .= "<li><span><a href='javascript:void(0);' onclick='loadGuiasTuristicos(" . ($page + 1) . ")'>$nextlabel</a></span></li>";
		} else {
			$out .= "<li class='disabled'><span><a>$nextlabel</a></span></li>";
		}
