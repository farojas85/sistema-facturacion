    ...
    <section class="container-fluid panel-medio">
        ...
        <div class="box rounded">
            ...
            <div class="box-body table-user">
                ...
                <div class="contenedor-busqueda">
                    <div class="input-group-search">
                        ...
                        <select class="selectpicker show-tick" data-style="btn-select" data-width="70px" id="selectnum"
                            name="selectnum" onchange="loadProductos(1)">
                ...
                <option value=" 20">20</option>
                        ...
                        <select class="selectpicker show-tick" data-style="btn-select" data-width="70px" id="activos"
                            name="activos" onchange="loadProductos(1)">
          ...
          <div class=" input-search">
                                <input type="search" class="search" id="searchProducto" name="searchProducto"
                                    placeholder="Buscar..." onkeyup="loadProductos(1)">
    ...
    <div class="modal-dialog">
                  ...
                  <div class="form-group"> -->
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" min="0" name="nuevoStock"
                                            id="nuevoStock" placeholder="Ingresar stock" value="0" />
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="nuevoComision" id="nuevoComision"
                                            placeholder="Valor Comisión" step="any" />
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="nuevoPrecioMayor"
                                            id="nuevoPrecioMayor" placeholder="Precio por mayor" value="0">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="modo-contenedor-series">
                                ...
                                <input type="checkbox" data-toggle="toggle" data-on="AGREGA SERIES"
                                    data-off="SIN SERIES" data-onstyle="primary" data-offstyle="danger"
                                    id="agregarSerie" name="agregarSerie" data-size="small" data-width="135" value="si">

                                <div class="series-productos">
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="seriep[]" id="seriep[]"
                                            placeholder="INGRESE LA SERIE">
                                        <span class="btn btn-primary btn-add-serie"
                                            style="position:absolute; right:-37px; top:-0px !important; color:#fff;"><i
        ...
        ======================================-->
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-agm btn-nuevo-producto">Guardar
                        producto</button>
    ...
    <div class="modal-dialog">
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control " name="editarDescripcion"
                                            id="editarDescripcion" required>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control " min="0" name="editarStock"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="editarPrecioUnitario"
                                            id="editarPrecioUnitario" placeholder="Ingresar precio de venta" step="any"
                                            required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="editarValorUnitario"
                                            id="editarValorUnitario" placeholder="Valor unitario" step="any" readonly
                                            required>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="editarigv" id="editarigv"
                                            placeholder="Ingresar IGV" readonly>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="editarPrecioMayor"
                                            id="editarPrecioMayor" placeholder="Precio compra" step="0.01" min="0">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="editarPrecioCompra"
                                            id="editarPrecioCompra" placeholder="Precio compra" step="0.01" min="0">
        ...
        ======================================-->
                ...
                <div class="modal-footer">
                    ...
                    <label class="btn btn-danger pull-left" data-dismiss="modal"><i
                            class="far fa-times-circle fa-lg"></i> Salir</label>
                    ...
                    <div role="tabpanel">
                        <ul class="nav nav-tabs">
                            ...
                            <li role="presentation">
                                <a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">AGREGAR NUEVAS
                                    SERIES</a>
                            </li>
                                ...
                                <form action="" id="aSeries" name="aSeries">
                                    ...
                                    <div class="series-productos-agregar">
                                        <div class="input-group" style="margin: 0 auto;">
                                            <input type="text" class="form-control" name="seriepn[]" id="seriepn"
                                                placeholder="INGRESE NUEVA SERIE">
                                            <span class="btn btn-primary btn-add-serie-agregar"
                                                style="position:absolute; right:-40px; top:-0px !important; color:#fff;"><i
                                                    class="fas fa-plus"></i></span>
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit"
                                            class="btn btn-primary btn-agm btn-nueva-serie">Guardar</button>
