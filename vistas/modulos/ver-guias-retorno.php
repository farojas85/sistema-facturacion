        ...
        <div class="box rounded">
            ...
            <div class="contenedor-busqueda">
                ...
                <div class="input-group-search">
                    ...
                    <select class="selectpicker show-tick" data-style="btn-select" data-width="70px" id="selectnum" name="selectnum" onchange="loadGuiasRetorno(1)">
                    ...
                    if ($_SESSION['perfil'] == 'Administrador') {
                        echo '
                    <select class="form-control select2" name="selectSucursal" id="selectSucursal" style="margin-left: 4px;" onchange="loadGuiasRetorno(1)">
                    ...
                    <div class="input-search">
                        <input type="search" class="search" id="searchGuiasR" name="searchGuiasR" placeholder="Buscar..." onkeyup="loadGuiasRetorno(1)">
                ...
                <table class="table table-bordered  tablaGuias" width="100%">
                    ...
                    <thead>
                        ...
                        <tr>
                            ...
                            <th width="118px">ACCIONES</th>
                        </tr>
                    </thead>
                    <?php

                    $listaguias = new ControladorGuiaRemision();
                    $listaguias->ctrListarGuiasRetorno();
