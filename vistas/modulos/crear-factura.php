                    ...
                    <div class="col-lg-12 col-xs-12">
                        ...
                        <div class="box box-success" style="border-top: 0px;">
                            ...
                            <form role="form" method="post" class="formVenta" id="formVenta">
                                ...
                                <input type="hidden" name="ruta_comprobante" id="ruta_comprobante"
                                    value="<?php echo  $_GET["ruta"] ?>">
                                <input type="hidden" class="" id="tipo_cambio" name="tipo_cambio" value=""
                                    style="width:70px; padding:5px">
                                <input type="hidden" class="" id="fecha" name="fecha"
                                    value="<?php echo date("Y-m-d") ?>">
                                <input type="hidden" class="" id="serieCorrelativo" name="serieCorrelativo"
                                    value="<?php echo $numCorrelativo; ?>">
                                <input type="hidden" id="afectoigv" name="afectoigv"
                                    value="<?php echo $emisor['afectoigv'] ?>">
                                <input type="hidden" id="icbper" name="icbper" value="<?php echo $emisor['icbper'] ?>">
                                <input type="hidden" id="codnumberws" name="codnumberws" value="51">
                                <input type="hidden" id="enviowsapi" name="enviowsapi"
                                    value="<?php echo $emisor['enviowsapi'] ?>">
                                    ...
                                    <div class="box" style="border: 0px; padding-top:0px;">
                                        ...
                                        <div class="col-md-3 col-xs-6">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" name="fechaDoc"
                                                        id="fechaDoc" value="<?php echo date("d/m/Y") ?>" required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-2 col-xs-6">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i
                                                            class="fa fa-calendar"></i></span>
                                                    <input type="text" class="form-control" name="fechaVence"
                                                        id="fechaVence" value="<?php echo date("d/m/Y") ?>" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-1 col-xs-6">
                                            <input type="checkbox" data-toggle="toggle"
                                                ...
                                                data-off="<i class=' fa fa-eye-slash'></i>" data-onstyle="primary"
                                                data-offstyle="danger" id="sucursalbtnof" name="sucursalbtnof"
                                                data-size="mini" data-width="60" value="on">
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <legend class="text-bold"
                                                style="margin-left:15px; font-size:1.3em; letter-spacing: 1px;">Cliente:
                                            </legend>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        ...
                                                        <span class="input-group-addon btn buscarRuc"><i
                                                                class="fa fa-search"></i></span>
                                                        <div id="reloadC"></div>
                                                        <div class="resultadoCliente" idCliente=""><a href="#"
                                                                class="btn-add"></a></div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <div class="input-group-adddon">
                                                        <input type="text" class="form-control" id="direccion"" name="
                                                            direccion" placeholder="Ingrese la dirección...">
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <div class="input-group-adddon">
                                                        <input type="text" class="form-control" id="ubigeo"" name="
                                                            ubigeo" placeholder="Código de ubigeo...">
                                                        <!-- <span class="input-group-addon"><i class="fa fa-search"></i></span>  -->
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group-adddon">
                                                        <input type="text" class="form-control" id="celular"" name="
                                                            celular" placeholder="Ingrese número celular...">
                                                        <!-- <span class="input-group-addon"></span>  -->
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3 pull-right" style="text-align: center;">
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        <label class="wtstext" for="" style="margin-right: 5px;">¿Desea
                                                            enviar al whatsapp?</label><br />
                                                        <input type="checkbox" data-toggle="toggle" data-on="Sí"
                                                            data-off="No" data-onstyle="primary" data-offstyle="danger"
                                                            id="enviawsc" name="enviawsc" data-size="mini"
                                                            data-width="60" value="si">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row" style="margin-bottom: 7px; padding-bottom: 4px;">
                                            <div class="col-md-6">
                                                ...
                                                <label style="border-style:none;" id="emailtext" for=""> ¿Deseas Enviar
                                                    el Comprobante Electrónico al Email del Cliente?</label>

                                                <div class="modo-contenedor-email">
                                                    <label for="si" id="sie">Sí</label>
                                                    <input type="radio" class="modoemail" id="si" name="modoemail"
                                                        value="s">
                                                    <label for="no" id="noe">No</label>
                                                    <input type="radio" class="modoemail" id="no" name="modoemail"
                                                    ...
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="email" class="form-control" id="email"" name="
                                                                email" placeholder="Ingrese el correo del cliente...">
                                            ...
                                            <div class="col-md-3 contenedor-cuotas">
                                                <div class="cuotas-float">
                                                    ...
                                                    <div class="pago-cuotas">
                                                        <div class="form-group">
                                                            <input type="hidden" name="totalOperacion"
                                                                id="totalOperacion" value="">
                                                            <input type="text" class="form-control" id="fecha_cuota"
                                                                name="fecha_cuota[]" placeholder="Fecha cuota 1">

                                                        </div>
                                                        <div class="form-group" style="margin-top: -12px;">
                                                            <input type="number" class="form-control" id="cuotas"
                                                                name="cuotas[]" placeholder="Monto cuota 1">
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-lg-12 col-xs-12">
                                            <div class="row nuevoProducto">
                                                ...
                                                <div class="flex">
                                                    ...
                                                    <input type="search" id="searchpc" name="searchpc"
                                                        placeholder="Escanear código">
                                                    <?php if ($_SESSION['perfil'] == 'Administrador') : ?>
                                                    <button type="button"
                                                        class="btn btn-success btn-radius pull-right btnproser"
                                                        data-toggle="modal"
                                                        data-target="#modalAgregarProducto"></i>Nuevo producto o
                                                        servicio <i class="fa fa-th"></i>
                                                    </button>
                                                    <?php endif ?>
                                                    <button type="button"
                                                        class="btn btn-primary pull-right btn-agregar-carrito"
                                                        data-toggle="modal" data-target="#modalProductosVenta"><i
                                                            class="fas fa-cart-plus fa-lg"></i> Agregar Productos o
                                                        Servicios</button>
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td>
                                                                            <div class="box row">
                                                                                <div
                                                                                    class="col col-lg-12 col-sm-12 col-xs-12">
                                                                                    <div
                                                                                        class="contenedor-tipo-descuento">
                                                                                        <label for="porcen" id="por"
                                                                                            class="">%</label>
                                                                                        <input type="radio" id="porcen"
                                                                                            class="tipo_desc"
                                                                                            name="tipo_desc" value="%">
                                                                                        <label for="soles" id="sol"
                                                                                            class="">S/</label>
                                                                                        <input type="radio" id="soles"
                                                                                            class="tipo_desc"
                                                                                            name="tipo_desc" value="S/"
                                                                                            checked />
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                                        ...
                                                                                        <div class="input-group">
                                                                                            ...
                                                                                            <span
                                                                                                class="input-group-addon"><i
                                                                                                    class="fas fa-percent descicono"></i></span>
                                                                                            <input type="number"
                                                                                                class="form-control"
                                                                                                min="0"
                                                                                                placeholder="0.00"
                                                                                                id="descuentoGlobalP"" name="
                                                                                                descuentoGlobalP"
                                                                                                value="0"
                                                                            ...
                                                                            <div class="form-group">
                                                                                <div class="input-group">
                                                                                    ...
                                                                                    <select style="width: 100%;"
                                                                                        ...
                                                                                        id="metodopago"
                                                                                        name="metodopago">
                                                                                        <option value="009">En efectivo
                                                                                        </option>
                                                                                        <option value="001">Depósito en
                                                                                            cuenta</option>
                                                                                        <option value="005">Tarjeta de
                                                                                            débito</option>
                                                                                        <option value="006">Tarjeta de
                                                                                            crédito</option>
                                                                                        <option value="003">
                                                                                            Transferencia bancaria
                                                                                        </option>
                                                                                        <option value="002">Giro
                                                                                        </option>
                                                                                    </select>
                                                                                </div>
                                                                            </div>
                                                                    ...
                                                                    <tr>
                                                                        <td colspan="2">
                                                                            <div
                                                                                class="contenedor-selva load-detracciones-servicios-selva">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        <div class="input-group-adddon">
                                                                            <input type="text" class="form-control"
                                                                                id="total_vuelto"" name=" total_vuelto"
                                            ...
                                            <div class="col-md-12 col-lg-8 contenedor-detracciones">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="col-md-9">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control select2" id="tipodetraccion"
                                                                name="tipodetraccion" style="width: 100%;">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <div class="form-group">
                                                            <input type="number" min="0" max="100" class="form-control"
                                                                name="pordetraccion" id="pordetraccion">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="col-md-9">
                                                        ...
                                                        <div class="form-group">
                                                            <select
                                                                class="form-control tipo_pago_detraccion select select2-hidden-accessiblev"
                                                                name="tipo_pago_detraccion" id="tipo_pago_detraccion"
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <div class="form-group">
                                                            <input type="text" class="form-control"
                                                                name="totaldetraccion" id="totaldetraccion" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="col-md-9">
                                                        ...
                                                        <div class="form-group conte-cuentadetraccion">
                                                            ...
                                                            <select class="form-control select2" id="cuentadetraccion"
                                                                name="cuentadetraccion" style="width: 100%;">
                                                                <option value="">Seleccione una Cuenta de Detracción
                                                                </option>
                                                                <?php
                                                                $item = null;
                                                                $valor = null;
                                                ...
                                                <div class="msg-sunat-detraccion">
                                                    <i class="fas fa-comment-dots"></i> Operacion Sujeta a Detracción:
                                                    Debe existir al menos un artículo sujeto a detracción. Escoger el
                                                    mayor porcentaje en caso exista más de uno<br>Resolución 183-204
                                                    SUNAT/15.08.2004.
                                                </div>
                                            </div>
                                            <!-- FIN DETRACCIONES=============================== -->
                      ...
                      <label for="no">Solo Guardar Venta</label>
                                    ...
                                    <div class="box-footer contenedor-btns-carrito">
                                        ...
                                        <button type="button" class="btnGuardarVenta"><i
                                                class="far fa-save"></i></button>

                                        <!-- BOTÓN PARA ELIMINAR CARRO-->
                                        <button type="button" class="btnEliminarCarro"><i
...
<div class="modal fade bd-example-modal-lg" id="modalProductosVenta" tabindex="-1" role="dialog"
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" data-dismiss="modal"><i
                            class="far fa-times-circle fa-lg"></i> Cerrar</button>
    ...
    <div class="modal-dialog">
        ...
        ======================================-->
                ...
                <div class="modal-body">
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <select class="select2" name="nuevaSucursal" id="nuevaSucursal"
                                            style="width: 100%">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group product">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="nuevoCodigo" id="nuevoCodigo"
                                                placeholder="Código" autocomplete="off">

                                            <span class="input-group-addon bar-code-btn"><i
                  ...
                  <div class="form-group"> -->
                                ...
                                <input type="hidden" class="form-control" name="nuevaSerie" id="nuevaSerie"
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="nuevaDescripcion"
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" min="0" name="nuevoStock"
                                            id="nuevoStock" placeholder="Ingresar stock" required>
                            ...
                            <div class="row">
                                <div class="col-md-6" style="">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="nuevoPrecioUnitario"
                                            id="nuevoPrecioUnitario" placeholder="Ingresar precio unitario" step="any"
                                            required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="nuevoValorUnitario"
                                            id="nuevoValorUnitario" placeholder="Valor unitario" step="any" readonly
                                            required>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="nuevoigv" id="nuevoigv"
                                            placeholder="IGV 18%" readonly>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="nuevoPrecioMayor"
                                            id="nuevoPrecioMayor" placeholder="Precio por mayor">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="nuevoPrecioCompra"
                                            id="nuevoPrecioCompra" placeholder="Precio compra">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="img-contenedor">
                                ...
                                <img src="vistas/img/productos/default/anonymous.png"
                                    class="img-thumbnail previsualizar" width="130px">
        ...
        ======================================-->
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-danger pull-left" data-dismiss="modal"><i
