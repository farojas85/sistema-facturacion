          ...
          <div class="col-lg-12 col-xs-12">
            ...
            <div class="box box-success" style="border-top: 0px;">
              ...
              <form role="form" method="post" class="formVenta" id="formVenta">
                ...
                <input type="hidden" id="enviowsapi" name="enviowsapi" value="<?php echo $emisor['enviowsapi'] ?>">
                  ...
                  <div class="box" style="border: 0px; padding-top:0px;">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-2">
                        <div class="form-group">
                          <div class="input-group-adddon">
                            <input type="text" class="form-control" id="ubigeo"" name=" ubigeo" placeholder="Código de ubigeo...">
                            <!-- <span class="input-group-addon"><i class="fa fa-search"></i></span>  -->
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-3">
                        <div class="form-group">
                          <div class="input-group-adddon">
                            <input type="text" class="form-control" id="celular"" name=" celular" placeholder="Ingrese número celular...">
                            <!-- <span class="input-group-addon"></span>  -->
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                      <div class="input-group">
                        <label class="wtstext" for="" style="margin-right: 5px;">¿Desea enviar al whatsapp?</label><br/>
                      <input type="checkbox" data-toggle="toggle" data-on="Sí" data-off="No" data-onstyle="primary" data-offstyle="danger" id="enviawsc" name="enviawsc" data-size="mini" data-width="60" value="si">
                      </div>
                      </div>
                      </div>
