                      ...
                      <div class="col-md-3 contenedor-cuotas">
                        <div class="cuotas-float">
                          ...
                          <div class="pago-cuotas">
                            <div class="form-group">
                              <input type="hidden" name="totalOperacion" id="totalOperacion" value="Escanear código">
                      ...
                      <div class="row nuevoProducto">
                        ...
                        <div class="flex">
                          ...
                          <?php if ($_SESSION['perfil'] == 'Administrador') : ?>
                            <button type="button" class="btn btn-success btn-radius pull-right btnproser" data-toggle="modal" data-target="#modalAgregarProducto">Nuevo producto o servicio <i class="fa fa-th"></i>
                            </button>
                          <?php endif ?>
