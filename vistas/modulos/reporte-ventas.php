        ...
        <div class="box-body table-user">
          ...
          <div class="contenedor-busqueda">
            ...
            <div class="form-group contenedor-btn-reportes">
              ...
              <button class="btn btn-danger  btn-reporte-pdf" data-toggle="modal" data-target="#modalImprimir"><i class="fa fa-file-pdf fa-lg" style="color:red;"></i></button>
              <div class="box-tools pull-right reporte-ventas-excel" width="100%">

                <a class="btn btn-success " href="vistas/modulos/descarga_reporte_ventas.php?reporte=reporte"><i class="fa fa-file-excel fa-lg"></i></a>
              </div>
              <button class="btn btn-primary btn-show-envio"><i class="fa fa-paper-plane fa-lg"></i> </button>
            ...
            <div class="input-group-search">
              ...
              if ($_SESSION['perfil'] == 'Administrador') {
                echo '
              <select class="form-control select2" name="selectSucursal" id="selectSucursal" style="margin-left: 4px;" onchange="loadReportes(1)">
