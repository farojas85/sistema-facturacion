                ...
                <div class="row fechas-reportes ini-calendar-hide">
                    <div class="col-md-3">
                        <div class="input-group">
                            ...
                            <input type="text" class="fechareportes" id="fechaInicial" name="fechaInicial"
                                placeholder="Fecha Inicial..." style="width:100%" value="<?php echo date("d/m/Y"); ?>">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fas fa-calendar-alt"></i></span>
                            <input type="text" class="fechareportes" id="fechaFinal" name="fechaFinal"
                                placeholder="Fecha Final..." style="width:100%" value="<?php echo date("d/m/Y"); ?>"">
               </div>
             </div>
          </div>
          <!-- fin row fechas -->
<div class=" col-md-12 row-sucursal">
              ...
              ?>
                        ...
                        <div class=" box-tools pull-right" style="position: relative">
                            ...
                            <input type="checkbox" data-toggle="toggle" data-on="<i class=' fa fa-eye'></i>"
                                data-off="<i class=' fa fa-eye-slash'></i>" data-onstyle="primary"
                                data-offstyle="danger" id="sucursalbtnof" name="sucursalbtnof" data-size="mini"
                                data-width="60" value="on">
              ...
              ?>
                            <div class="btn-group">
                                <button type="button"
                                    class="btn btn-primary dropdown-toggle btn-calendar btn-rango-fechas"
                                    data-toggle="dropdown">
                                    <i class="far fa-calendar-alt"></i> Hoy</button>
                                <ul class="dropdown-menu calendar-reports" role="menu">
                                    <li><a href="#" class="exit-c" ini="<?php echo $hoy; ?>"
                                            fin="<?php echo $hoy; ?>">Hoy</a></li>
                                    <li><a href="#" class="exit-c" ini="<?php echo $ayer; ?>"
                                            fin="<?php echo $ayer; ?>">Ayer</a></li>
                                    <li><a href="#" class="exit-c" ini="<?php echo $semana; ?>"
                                            fin="<?php echo $hoy; ?>">Hace una semana</a></li>
                                    <li><a href="#" class="exit-c" ini="<?php echo $mes; ?>"
                                            fin="<?php echo $hoy; ?>">Este mes</a></li>
                                    <li><a href="#" class="exit-c" ini="<?php echo $ano; ?>"
                                            fin="<?php echo $hoy; ?>">Hace una año</a></li>
                                    <li class="divider"></li>
                                    <li><a href="#" ini="<?php echo $hoy; ?>" fin="<?php echo $hoy; ?>"
                                            class="personalizado">Personalizado</a></li>
                                </ul>
                            </div>
