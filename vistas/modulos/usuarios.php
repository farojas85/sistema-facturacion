                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <button class="btn btn-danger btnEliminarUsuario"
                                        ...
                                        usuario="<?php echo $value['usuario'] ?>"><i
                    ...
                    <div class="box-body">
                        <div class="col-md-8">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control " name="nuevoDni" id="nuevoDni"
                                    placeholder="Ingresar D.N.I." required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control " name="nuevoEmail" id="nuevoEmail"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control nuevoUser" name="nuevoUsuario"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control " name="nuevoPassword"
                                            id="nuevoPassword" placeholder="Ingresar contraseña" required>
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control " id="editarDni" name="editarDni" value=""
                                    required>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control " name="editarPerfil">
                                    ...
                                    <option value="<?php echo $_SESSION['perfil'] ?>"><?php echo $_SESSION['perfil'] ?>
                                    </option>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="img-contenedor">
                                ...
                                <img src="vistas/img/usuarios/default/logo.svg" class="img-thumbnail previsualizar"
                                    width="130px">
