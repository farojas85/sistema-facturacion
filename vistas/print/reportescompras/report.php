...
<page backtop="5mm" backbottom="5mm" backleft="5mm" backright="5mm">
    ...
    <table class="tabla-comprobantes">
        <tr>
            ...
            ?>
            <th colspan="8" class="titulo">REPORTE DE COMPRAS - <?php echo $nombre_comp; ?></th>
        </tr>
        <tr>
            <th>#</th>
            <th>COMP.</th>
        ...
        foreach ($resultado as $k => $value) :
            ...
            if (($value['tipocomp'] == '01' || $value['tipocomp'] == '02' || $value['tipocomp'] == '03' || $tipocomp == '00') && $value['anulado'] == 'n') {
       ...
       <td class="v15">' . $value['total'] . '</td>
            ...
            if (($value['tipocomp'] == '07' || $value['tipocomp'] == '08')) {
